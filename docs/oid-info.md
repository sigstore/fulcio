...
| server_url + repository + "/actions/runs/" + run_id + "/attempts/" + run_attempt | server_url + project_path + "/-/jobs/" + job_id                                                   | server_url + "/" organization_slug + "/" + pipeline_slug + "/builds/" + build_number + "#" + job_id | platform_url + "/build/" + workflow_id                                          | platform_url + "/workflow/" + workflow-id + "/job/" + job-id                                                                       | base_url + "/" + workspace_domain + "/" + project_name + "/pipelines/pipeline/" + pipeline_id + "/execution/" + execution_id | Run Invocation URI                      | An immutable identifier that can uniquely identify the build execution                                                                                                                 |
