...
| repository_id                                                                    | project_id                                                                                        | N/A                                                                                                 | N/A                                                                             | oidc.circleci.com/project-id         | Source Repository Identifier            | Stable identifier for the owner of the source repository.                                                                                                                              |
| server_url + repository_owner                                                    | server_url + namespace_path                                                                       | N/A                                                                                                 | N/A                                                                             | CIRCLE_REPOSITORY_URL                | Source Repository Owner URI             | Fully qualified URL for the owner of the source repository.                                                                                                                            |
| repository_owner_id                                                              | namespace_id                                                                                      | N/A                                                                                                 | N/A                                                                             | CIRCLE_ORGANIZATION_ID               | Source Repository Owner Identifier      | Stable identifier for the owner of the source repository.                                                                                                                              |
| server_url + workflow_ref                                                        | "https://" + ci_config_ref_uri                                                                    | N/A                                                                                                 | platform_url + "/api/pipelines/" + pipeline_id                                  | url_to_circleci_config_in_vcs+ref    | Build Config URI                        | A reference to the initiating build instructions.                                                                                                                                      |
