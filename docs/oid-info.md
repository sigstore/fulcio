...
| runner_environment                                                               | runner_environment                                                                                | runner_environment                                                                                  | runner_environment                                                              | runner_environment                                                                     | Runner Environment                      | For platforms to specify whether the build took place in platform-hosted cloud infrastructure or customer-hosted infrastructure. For example: `platform-hosted` and `self-hosted`.     |
