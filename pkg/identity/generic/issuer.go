...
func Issuer(issuerURL string) identity.Issuer {
	return &genericIssuer{base.Issuer(issuerURL)}
}

func (e *genericIssuer) Authenticate(ctx context.Context, token string, opts ...config.InsecureOIDCConfigOption) (identity.Principal, error) {
