...
// ContextValidate validates this submit success based on context it is used
func (m *SubmitSuccess) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
