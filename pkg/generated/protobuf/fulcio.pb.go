...
var file_fulcio_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x6e, 0x74, 0x22, 0x96, 0x01, 0x0a, 0x12, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67,
	...
	0x63, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x3e, 0x0a,
	...
	0x65, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x52, 0x05, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x22, 0x4f, 0x0a,
	...
	0x32, 0x35, 0x35, 0x31, 0x39, 0x10, 0x03, 0x32, 0x92, 0x02, 0x0a, 0x02, 0x43, 0x41, 0x12, 0x9f,
	...
	0x12, 0x6a, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x75, 0x73, 0x74, 0x42, 0x75, 0x6e, 0x64,
	...
	0x2e, 0x76, 0x32, 0x2e, 0x54, 0x72, 0x75, 0x73, 0x74, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x22,
	0x1b, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x15, 0x12, 0x13, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32,
	0x2f, 0x74, 0x72, 0x75, 0x73, 0x74, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x42, 0x5a, 0x0a, 0x16,
	0x64, 0x65, 0x76, 0x2e, 0x73, 0x69, 0x67, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x66, 0x75, 0x6c,
...
var file_fulcio_proto_goTypes = []interface{}{
	...
	(*TrustBundle)(nil),                     // 5: dev.sigstore.fulcio.v2.TrustBundle
	(*CertificateChain)(nil),                // 6: dev.sigstore.fulcio.v2.CertificateChain
...
var file_fulcio_proto_depIdxs = []int32{
	...
	6, // 3: dev.sigstore.fulcio.v2.SigningCertificate.chain:type_name -> dev.sigstore.fulcio.v2.CertificateChain
	6, // 4: dev.sigstore.fulcio.v2.TrustBundle.chains:type_name -> dev.sigstore.fulcio.v2.CertificateChain
	1, // 5: dev.sigstore.fulcio.v2.CA.CreateSigningCertificate:input_type -> dev.sigstore.fulcio.v2.CreateSigningCertificateRequest
	7, // 6: dev.sigstore.fulcio.v2.CA.GetTrustBundle:input_type -> google.protobuf.Empty
	4, // 7: dev.sigstore.fulcio.v2.CA.CreateSigningCertificate:output_type -> dev.sigstore.fulcio.v2.SigningCertificate
	5, // 8: dev.sigstore.fulcio.v2.CA.GetTrustBundle:output_type -> dev.sigstore.fulcio.v2.TrustBundle
