...
type PublicKey struct {
	...
	Algorithm PublicKeyAlgorithm `protobuf:"varint,1,opt,name=algorithm,proto3,enum=dev.sigstore.fulcio.v1.PublicKeyAlgorithm" json:"algorithm,omitempty"`
	//
...
type SigningCertificate struct {
	...
	SignedCertificateTimestamp []byte `protobuf:"bytes,1,opt,name=signed_certificate_timestamp,json=signedCertificateTimestamp,proto3" json:"signed_certificate_timestamp,omitempty"`
	//
...
func (x *SigningCertificate) GetSignedCertificateTimestamp() []byte {
	if x != nil {
...
func (x *SigningCertificate) GetChain() *CertificateChain {
	if x != nil {
		return x.Chain
	}
	return nil
...
type TrustBundle struct {
	...
	//
	// The PEM-encoded root certificate chain for this Fulcio instance
...
func (x *TrustBundle) GetChain() *CertificateChain {
	if x != nil {
		return x.Chain
	}
	return nil
...
var file_fulcio_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xe9, 0x01, 0x0a, 0x1f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x69, 0x67,
	...
	,
	...
	0x74, 0x65, 0x6e, 0x74, 0x22, 0x9b, 0x01, 0x0a, 0x12, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67,
	0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x40, 0x0a, 0x1c, 0x73,
	...
	,
...
var file_fulcio_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_fulcio_proto_goTypes = []interface{}{
	(PublicKeyAlgorithm)(0),                 // 0: dev.sigstore.fulcio.v1.PublicKeyAlgorithm
	(*CreateSigningCertificateRequest)(nil), // 1: dev.sigstore.fulcio.v1.CreateSigningCertificateRequest
	(*Credentials)(nil),                     // 2: dev.sigstore.fulcio.v1.Credentials
	(*PublicKey)(nil),                       // 3: dev.sigstore.fulcio.v1.PublicKey
	(*SigningCertificate)(nil),              // 4: dev.sigstore.fulcio.v1.SigningCertificate
	(*TrustBundle)(nil),                     // 5: dev.sigstore.fulcio.v1.TrustBundle
	(*CertificateChain)(nil),                // 6: dev.sigstore.fulcio.v1.CertificateChain
	(*empty.Empty)(nil),                     // 7: google.protobuf.Empty
}
var file_fulcio_proto_depIdxs = []int32{
	2, // 0: dev.sigstore.fulcio.v1.CreateSigningCertificateRequest.credentials:type_name -> dev.sigstore.fulcio.v1.Credentials
	3, // 1: dev.sigstore.fulcio.v1.CreateSigningCertificateRequest.public_key:type_name -> dev.sigstore.fulcio.v1.PublicKey
	0, // 2: dev.sigstore.fulcio.v1.PublicKey.algorithm:type_name -> dev.sigstore.fulcio.v1.PublicKeyAlgorithm
	6, // 3: dev.sigstore.fulcio.v1.SigningCertificate.chain:type_name -> dev.sigstore.fulcio.v1.CertificateChain
	6, // 4: dev.sigstore.fulcio.v1.TrustBundle.chain:type_name -> dev.sigstore.fulcio.v1.CertificateChain
	1, // 5: dev.sigstore.fulcio.v1.CA.CreateSigningCertificate:input_type -> dev.sigstore.fulcio.v1.CreateSigningCertificateRequest
	7, // 6: dev.sigstore.fulcio.v1.CA.GetTrustBundle:input_type -> google.protobuf.Empty
	4, // 7: dev.sigstore.fulcio.v1.CA.CreateSigningCertificate:output_type -> dev.sigstore.fulcio.v1.SigningCertificate
	5, // 8: dev.sigstore.fulcio.v1.CA.GetTrustBundle:output_type -> dev.sigstore.fulcio.v1.TrustBundle
